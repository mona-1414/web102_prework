...
const summary = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games.
${unfundedGamesCount===0 ? "All of our games are funded!" : `Currently, ${unfundedGamesCount} ${unfundedGamesCount === 1 ? "game":"games"} remain unfunded. We need your help to fund these amazing games!`}`;
...
topElement.textContent=`Top Most Funded Game: ${top.name}`;
